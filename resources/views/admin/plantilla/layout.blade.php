...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('chosen/chosen.css') }}"> <!-- css de plugin chosen-->
...
<div class="wrapper">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-right">
                  <a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Cerrar Sesion
                  </a>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      @include('flash::message') <!-- Muestra el mensaje flash-->
     @include('admin.plantilla.partial.errors')
      @yield('content')
...
<!-- Optionally, you can add Slimscroll and FastClick plugins.
     ...
     @yield('js')<!-- Este yield es para llamar al estilo chosen de jquery-->
</body>
</html>
