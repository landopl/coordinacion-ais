        		...
        		<div class="col-xs-12">
                    ...
                    <?php echo Form::close(); ?>
                        ...
                        <tr> 
                          ...
                          <td><a href="<?php echo e(route('admin.coordinadores.destroy', $coordinador->id)); ?>" onclick="return confirm('¿Esta seguro que desea eliminar el investigador?')" class="btn btn-default btn-flat">Eliminar</a></td>
                        </tr>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
				            </table>
