...
<head>
  ...
  <link rel="stylesheet" href="<?php echo e(asset('chosen/chosen.css')); ?>"> <!-- css de plugin chosen-->
...
<div class="wrapper">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-right">
                  <a href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Cerrar Sesion
                  </a>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p>
            <?php if(Auth::user()->name == 'landopl95'): ?>
              Administrador  
            <?php else: ?>
              Usuario Comun
            <?php endif; ?>
       ...
       <!-- <li class="active"><a href="#"><i class="fa fa-link"></i> <span>Link</span></a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo e(route('coordinadores.index')); ?>">Coordinadores</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <?php echo $__env->make('flash::message', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?> <!-- Muestra el mensaje flash-->
     <?php echo $__env->make('admin.plantilla.partial.errors', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2017 <a href="#">Coordinacion de investigacion</a>.</strong> realizado por Orlando Peña.
  </footer>
...
<!-- Optionally, you can add Slimscroll and FastClick plugins.
     ...
     <?php echo $__env->yieldContent('js'); ?><!-- Este yield es para llamar al estilo chosen de jquery-->
</body>
</html>
