	...
	<body class="hold-transition skin-blue sidebar-mini">
		<section class="content">
    		...
    		<div class="col-xs-12">
              ...
              <?php echo Form::open(['route' => 'proyectos.index', 'method' => 'GET', 'class' => 'navbar-form pull-right']); ?>

                <div class="input-group">
                  <?php echo Form::text('titulo', null, ['class' => 'form-control', 'placeholder' => 'Buscar por titulo', 'aria-describedby' => 'titulo']); ?>
